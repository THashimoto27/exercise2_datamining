...
Also, We tried to do the same regression on the way of K-CV, and then we got the rmse of the linear regression(basic model) is 65608.13, that of linear model 4 is 60768.54, and that of the KNN regression is 62411.67. This results looks like the same as the way of the ten-times average.
