...
model_dev <- glm(children~.,data=hotels_dev_train, family=binomial)
...
predict3 <- predict(model_dev, newdata=hotels_dev_test, type='response')

# rmse
rmse1 <- rmse(baseline1,hotels_dev_test )
rmse2 <- rmse(baseline2,hotels_dev_test )
rmse3 <- rmse(model_dev,hotels_dev_test )
