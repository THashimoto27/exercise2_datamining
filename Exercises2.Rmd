...
model_dev <- glm(children~.-arrival_date,data=hotels_dev_train_newmodel, family=binomial)
...
rmse3_1 <- rmse(glmstep_b1,hotels_dev_test)
rmse3_2 <- rmse(glm_forward,hotels_dev_test)
